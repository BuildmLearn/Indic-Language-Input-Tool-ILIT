...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public DBHelper(Context context,String l) {
        super(context, l+".sqlite", null, DATABASE_VERSION);
...
Log.d("DataBaseHelper", "Constructor called");
    ...
    public String getDatabaseFileName(String lang)
    {
        return lang + ".sqlite";
    }
    ...
    public void createDataBase() throws IOException {
        if(DBLanguage.hasPrediction(lang)) {
    ...
    private void copyDataBase() throws IOException {
        ...
        InputStream myInput = ourContext.getAssets().open(getDatabaseFileName(lang));
        String outFileName = ourContext.getFilesDir().getAbsolutePath()
                .replace("files", "databases")
                + File.separator + getDatabaseFileName(lang);
