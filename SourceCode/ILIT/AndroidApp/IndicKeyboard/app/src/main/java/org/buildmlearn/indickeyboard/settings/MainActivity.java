...
public class MainActivity extends FragmentActivity {
	...
	public String getStringResourceByName(String aString) {
		...
		int resId=getResources().getIdentifier("hindi_"+ aString,"string",getPackageName());
	...
	public void showInputEnableSettings() {
		startActivityForResult(new Intent(
				Settings.ACTION_INPUT_METHOD_SETTINGS), 0);
	}
	...
	public void openSettingsApp() {
		Intent intent = new Intent(this,
				org.buildmlearn.indickeyboard.settings.SettingsActivity.class);
